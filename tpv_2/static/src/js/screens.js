     	...
     	validate_order: function(options) {
			...
			if (this.pos.config.iface_cashdrawer) {
             ...
             if(options.invoice){
            	 ...
            	 //por eso se realizó llamada al super y este sea el quien llame a la 
            	 //impresióel comprobante, cuando se utiliza impresióirecta a ticketera.
            	 //Sinembargo se realizó consulta en Stackoverflow:
