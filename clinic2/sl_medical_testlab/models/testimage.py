...
class Patient_TestImage(models.Model):

    _name = 'clinic.testimage'

    @api.model
    def _get_default_name(self):
        return self.env['ir.sequence'].get('clinic.testimage')

    name = fields.Char('Código prueba imagen', default=_get_default_name)
    ...
    test_attach_line = fields.One2many('clinic.test.attachment', 'testimage_id', 'Adjuntos')
