...
class Consult_Type(models.Model):

    _name = 'clinic.consult.type'
    ...
    code_consult = fields.Char('Código tipo consulta')
    description = fields.Text('Descripción')

    @api.model
    @api.returns('self', lambda value: value.id)
    def create(self, vals):
        vals['is_consult'] = True
        return super(Consult_Type, self).create(vals)